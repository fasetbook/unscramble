...
class LoadingThread(QThread):
    valueChanged = pyqtSignal(float)  # XXX

    def __init__(self, *args, **kwargs):
        super(LoadingThread, self).__init__(*args, **kwargs)
        self.totalValue = randint(100, 200)  # XX
    def run(self):
...
class PushButtonLine(QPushButton):
    ...
    def __init__(self, *args, **kwargs):
        self._waitText = kwargs.pop("waitText", "XX")
...
class Window(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        layout.addWidget(PushButtonLine("XXX"))
        layout.addWidget(PushButtonLine("XXX").setLineColor("#ef5350"))
        layout.addWidget(PushButtonLine("XXX").setLineColor("#ffc107"))
